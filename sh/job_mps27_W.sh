...
#SBATCH --mem=100G
#SBATCH --time=3:00:00
#SBATCH --output=/ix/pgivi/moe32/Aidyn_DNS/stats/mps_chi27_jobs/mps27_W_%j.out
...
echo "[mps chi=27] component file = W_t1.mat"
"$JULIA" mps_calc.jl \
    chi=27 \
    cutoff=0.0 \
    split=1 \
