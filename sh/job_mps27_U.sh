...
#SBATCH --mem=100G
#SBATCH --time=3:00:00
#SBATCH --output=/ix/pgivi/moe32/Aidyn_DNS/stats/mps_chi27_jobs/mps27_U_%j.out
...
echo "[mps chi=27] component file = U_t1.mat"
"$JULIA" mps_calc.jl \
    chi=27 \
    cutoff=0.0 \
    split=1 \
