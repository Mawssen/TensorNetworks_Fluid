...
#SBATCH --mem=200G
#SBATCH --time=3:00:00
#SBATCH --output=/ix/pgivi/moe32/Aidyn_DNS/stats/mps_chi29_jobs/mps29_u_%j.out
...
echo "[mps chi=29] component file = jet_u_0198"
"$JULIA" mps_calc.jl \
    chi=29 \
    cutoff=0.0 \
    split=1 \
...
echo "[mps chi=29] jet_u_0198 done."
