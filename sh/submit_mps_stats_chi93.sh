#!/bin/bash
#SBATCH --job-name=mps_stats_chi93
#SBATCH --output=mps_stats_chi93_%j.out
#SBATCH --error=mps_stats_chi93_%j.err
#SBATCH --nodes=1
...
# -----------------------------------------------------------------------------
# One-shot SLURM job: compute MPS stats for the chi=93 (LES-matched) case.
# Assumes 7 fields are already truncated at chi=93:
#   truncated_0198/sp1/truncated_jet_<var>_0198.dat_512_il_chi93.mat
# for var in mixfrac T Y_CO Y_CO2 Y_OH Y_O2 alpha
#
# Submit:
#   sbatch submit_mps_stats_chi93.sh
# -----------------------------------------------------------------------------
...
# Locate input dir (same convention as submit_mps_stats.sh)
